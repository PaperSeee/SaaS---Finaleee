        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div className="space-y-8 xl:col-span-1">
            ...
            <p className="text-gray-500 text-base leading-6">
              Kritiqo aide les entreprises à centraliser et gérer efficacement leurs avis clients pour améliorer leur réputation en ligne.
            </p>
            <div className="flex space-x-6">
              <a href="#" className="text-gray-400 hover:text-gray-500" onClick={(e) => e.preventDefault()}>
          ...
          <div className="mt-12 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 className="text-base font-medium text-gray-900">Produit</h3>
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 className="text-base font-medium text-gray-900">Entreprise</h3>
                <ul className="mt-4 space-y-4">
                  <li>
              ...
              <div className="mt-12 md:mt-0">
                <h3 className="text-base font-medium text-gray-900">Légal</h3>
                <ul className="mt-4 space-y-4">
                  <li>
