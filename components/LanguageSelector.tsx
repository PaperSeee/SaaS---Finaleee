...
export default function LanguageSelector() {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <div
        className={`absolute right-0 mt-2 w-48 rounded-md border border-gray-100 bg-white py-2 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none z-50 transition-all duration-200 ease-in-out transform origin-top-right ${
          isOpen 
      ...
      >
        {languages.map((lang) => (
          ...
          >
            ...
            {language === lang.code && (
              <svg
                className="h-4 w-4 text-blue-500 animate-scaleIn"
                viewBox="0 0 20 20"
                fill="currentColor"
              >
                <path
